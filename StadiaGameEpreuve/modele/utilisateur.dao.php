...
//lors de la connexion, on vérifie si les informations sont correctes
...
//@param array $data Données à mettre à jour (username, email, etc.)
 ...
 function updateUser($id, $data) {
    try {
        ...
        // "," sert a enlever les espaces du formulaire de modification de profil
